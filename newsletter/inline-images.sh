...
# Inline replacements
sed -i '' "s|url('background.jpeg')|url(\"dat.aimage/jpeg;base64,$bg64\")|g" "$output_file"
sed -i '' "s|src=\"canada-logo.svg\"|src=\"dat.aimage/svg+xml;base64,$canada64\"|g" "$output_file"
sed -i '' "s|src=\"ssc-text.svg\"|src=\"dat.aimage/svg+xml;base64,$ssc64\"|g" "$output_file"
