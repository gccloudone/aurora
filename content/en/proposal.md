...
As cloud-native technologies become more prevalent within the Government of Canada, the independent deployment of open-source Kubernetes and proprietary Platform-as-a-Service (PaaS) environments by individual departments, without standardized oversight, has become unsustainable. This fragmented approach leads to inefficiencies, inconsistent compliance, and security gaps across departments. While some departments have implemented their own Kubernetes environments, many relying on proprietary solutions often turn to external vendors for support, increasing long-term costs and limiting the growth of in-house expertise necessary for building and maintaining these platforms.

Some of the departments with their own Kubernetes environments include:
...
**Andrew Sinkinson**: Director General of Cloud Operations Hosting Services at Shared Services Canada, responsible for overseeing the Aurora platform and ensuring it aligns with the strategic goals of the GC Cloud One initiative.

**Serge Leblanc**: Director of Cloud Operations Hosting Services at Shared Services Canada, responsible for managing day-to-day operations of the Aurora platform, focusing on technical implementation and operational alignment with strategic cloud objectives.

## Project vision

The goal of Aurora is to establish itself as a foundational platform for application hosting across the Government of Canada, enabling seamless integration between various cloud-native environments. Drawing inspiration from successful platforms like those in the BC Government and Platform One from the U.S. Department of Defense, Aurora will act as a centralized DevSecOps platform, offering government departments both the tooling and pre-approved software patterns needed to accelerate innovation and streamline development pipelines.
...
1. **Unify Kubernetes (CNP) and OpenShift environments** across GC departments to eliminate fragmentation while providing flexible, scalable hosting options that adapt to each department's specific needs.
...
4. **Build a centralized support structure** with a unified team dedicated to both RedHat OpenShift and CNP, reinforced by Special Interest Groups (SIGs) in key domains like architecture, networking, and security to drive cross-department collaboration and innovation.
...
2. **Incorporation of Proprietary and Open-Source Solutions** where both proprietary PaaS platforms (e.g., similar to RedHat OpenShift, VMware Tanzu) and open-source cloud-native Kubernetes platforms will be aligned to common standards to ensure interoperability across platforms, accommodating the diverse needs of various departments while maintaining seamless integration and compatibility.
...
One of the key challenges in building and operating a platform like Aurora is balancing flexibility with governance. Below are some of the identified risks and proposed mitigations:
