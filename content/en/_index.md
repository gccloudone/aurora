...
<article class="py-450">
  ...
  <gcds-grid tag="ul" columns="1fr" columns-tablet="1fr 1fr" columns-desktop="1fr 1fr 1fr" gap="450" class="hydrated">
    ...
    <li class="list-none">
      ...
      <p class="mb-400">We're excited to announce the upcoming Children's Illustrated Guide to Aurora, a fun and engaging way to explore complex cloud technologies.</p>
