...
## Core Pillars of Aurora OSS

The Aurora OSS platform is built on four core pillars:
...
The recommendations in this document aim to align with industry best practices and the security requirements specified in ITSG-22 / ITSG-33, though no explicit mapping exercise between them was conducted.

### Reporting a security issue

If you identify an issue with any of the Cloud Native Platform environments or with this architectural plan, please send an email (encrypted, if possible) to:
