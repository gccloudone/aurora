...
Navigate to the management cluster's Argo CD portal and delete the platform App of Apps (`platform-cluster-name`) responsible for deploying the Aurora platform charts to the target cluster.
...
```text
/landing_zones_163ent-P3/**/L2_blueprint_aurora
...
### Terragrunt cannot destroy Kubernetes resources
